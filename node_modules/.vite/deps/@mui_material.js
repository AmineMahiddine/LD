...
var ButtonGroup = React32.forwardRef(function ButtonGroup2(inProps, ref) {
  ...
  const getButtonPositionClassName = (index, childrenParam) => {
    ...
    const isLastButton = index === React32.Children.count(childrenParam) - 1;
  ...
  return (0, import_jsx_runtime37.jsx)(ButtonGroupRoot, _extends({
    ...
    children: (0, import_jsx_runtime37.jsx)(ButtonGroupContext_default.Provider, {
      value: context,
      children: React32.Children.map(children, (child, index) => {
...
var NativeSelect = React81.forwardRef(function NativeSelect2(inProps, ref) {
  ...
  return (0, import_jsx_runtime92.jsx)(React81.Fragment, {
